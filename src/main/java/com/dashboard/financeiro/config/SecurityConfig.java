...
import com.dashboard.financeiro.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/transactions/**").hasAnyRole("USER", "ANALYST", "ADMIN")
                ...
                .requestMatchers(HttpMethod.DELETE, "/api/transactions/**").hasAnyRole("ADMIN")
